...
SERVICES["ai_text_analyzer"]="projects/aiTextAnalyzer"
SERVICES["full_ai_process"]="projects/fullAIProcess"
...
DEPLOY["ai_text_analyzer"]="DOKPLOY_AI_TEXT_ANALYZE_WEBHOOK"
DEPLOY["full_ai_process"]="DOKPLOY_FULL_AI_PROCESS_WEBHOOK"
