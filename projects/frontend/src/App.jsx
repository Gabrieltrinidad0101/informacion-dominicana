...
const PAGE_TITLES = {
  ...
  mopc: ["MOPC", "Ministerio de Obras Públicas y Comunicaciones"],
        ...
        <div className="tweaks">
          ...
          <div className="tweaks-body">
            ...
            <div className="tweak-row">
              ...
              <div className="seg">
                {[["compact", "compacto"], ["comfy", "cómodo"]].map(([val, label]) => (
                  <button key={val} className={tweaks.density === val ? "on" : ""} onClick={() => setTweak('density', val)}>{label}</button>
                ))}
              </div>
            </div>
            <div className="tweak-row">
              ...
              <div className="seg">
                {[["dark", "oscuro"], ["light", "claro"]].map(([val, label]) => (
                  <button key={val} className={tweaks.theme === val ? "on" : ""} onClick={() => setTweak('theme', val)}>{label}</button>
                ))}
              </div>
            </div>
          </div>
