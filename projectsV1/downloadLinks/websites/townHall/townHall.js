...
export const getTownHallLinks = async (page, { link, institutionType, institutionName }, eventBus, metadata) => {
    ...
    for (const data of datas) {
        ...
        for (const i in downloadsLink) {
            ...
            await eventBus.emit('downloads', { institutionType, typeOfData: 'nomina', link, year, month, institutionName }, metadata)
        }
    }
}
